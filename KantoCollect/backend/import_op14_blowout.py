#!/usr/bin/env python3
"""
Import OP14 Blowout show data (Jan 22-23, 2026).
"""
import sys
sys.path.insert(0, '.')
...
transactions_data = [
    ...
    ("Free Poke", "22-Jan-26", "roughcollect", 0.00, 0.00),
]
...
print("=" * 80)
print("IMPORTING OP14 BLOWOUT SHOW")
print("=" * 80)
...
with Session(engine) as db:
    ...
    # Import transactions
    print(f"\n{'#':<4} {'Date':<12} {'Item':<25} {'Buyer':<20} {'Gross':<10} {'Net':<10} {'COGS':<10}")
    print("-" * 80)
    ...
    for i, (item_name, date_str, buyer_username, gross, net) in enumerate(transactions_data, 1):
        ...
        print(f"{i:<4} {date_str:<12} {item_name:<25} {buyer_username:<20} ${gross:>8.2f} ${net:>8.2f} {cogs_display:>9}")
        imported_count += 1
    ...
    print("-" * 80)
    print(f"{'TOTALS':<62} ${total_gross:>8.2f} ${total_net:>8.2f} ${total_cogs:>8.2f}")
